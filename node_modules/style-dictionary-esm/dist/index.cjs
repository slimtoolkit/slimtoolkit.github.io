...
var path4__default = /*#__PURE__*/_interopDefaultLegacy(path4);
...
var _template__default = /*#__PURE__*/_interopDefaultLegacy(_template);
var fs3__default = /*#__PURE__*/_interopDefaultLegacy(fs3);
...
function convertToBase64(filePath) {
  ...
  const body = fs2__default["default"].readFileSync(filePath, "binary");
...
var transforms_default = {
  ...
  "asset/path": {
    ...
    matcher: isAsset,
    transformer(token) {
      return path4__default["default"].join(process.cwd(), token.value);
    }
  },
  "asset/objC/literal": {
    type: "value",
...
var _dir = pathe.resolve(pathe.dirname(url.fileURLToPath((typeof document === 'undefined' ? new (require('u' + 'rl').URL)('file:' + __filename).href : (document.currentScript && document.currentScript.src || new URL('out.js', document.baseURI).href)))), "../templates");
var resolveTemplate = (_path) => pathe.join(_dir, _path);
...
`;
  ...
  "scss/map-flat": function({ dictionary, options: options2, file }) {
    const template = _template__default["default"](fs2__default["default"].readFileSync(resolveTemplate("scss/map-flat.template")));
  ...
  "scss/map-deep": function({ dictionary, options: options2, file }) {
    const mapTemplate = _template__default["default"](fs2__default["default"].readFileSync(resolveTemplate("scss/map-deep.template")));
...
`;
  ...
  "typescript/module-declarations": function({ dictionary, file, options: options2 }) {
    ...
    const _dir2 = pathe.resolve(pathe.dirname(url.fileURLToPath((typeof document === 'undefined' ? new (require('u' + 'rl').URL)('file:' + __filename).href : (document.currentScript && document.currentScript.src || new URL('out.js', document.baseURI).href)))), "../templates");
    const designTokenInterface = fs2__default["default"].readFileSync(
      pathe.resolve(_dir2, "../../types/DesignToken.d.ts"),
      { encoding: "UTF-8" }
    );
...
declare const ${moduleName}: ${JSON.stringify(treeWalker(dictionary.tokens), null, 2)}`;
  ...
  "android/resources": function({ dictionary, options: options2, file }) {
    const template = _template__default["default"](
      fs2__default["default"].readFileSync(resolveTemplate("android/resources.template"))
    );
  ...
  "android/colors": function({ dictionary, options: options2, file }) {
    const template = _template__default["default"](
      fs2__default["default"].readFileSync(resolveTemplate("android/colors.template"))
    );
    return template({ dictionary, file, options: options2, fileHeader: fileHeader_default });
  },
  "android/dimens": function({ dictionary, options: options2, file }) {
    const template = _template__default["default"](
      fs2__default["default"].readFileSync(resolveTemplate("android/dimens.template"))
    );
    return template({ dictionary, file, options: options2, fileHeader: fileHeader_default });
  },
  "android/fontDimens": function({ dictionary, options: options2, file }) {
    const template = _template__default["default"](
      fs2__default["default"].readFileSync(resolveTemplate("android/fontDimens.template"))
    );
    return template({ dictionary, file, options: options2, fileHeader: fileHeader_default });
  },
  "android/integers": function({ dictionary, options: options2, file }) {
    const template = _template__default["default"](
      fs2__default["default"].readFileSync(resolveTemplate("android/integers.template"))
    );
    return template({ dictionary, file, options: options2, fileHeader: fileHeader_default });
  },
  "android/strings": function({ dictionary, options: options2, file }) {
    const template = _template__default["default"](
      fs2__default["default"].readFileSync(resolveTemplate("android/strings.template"))
    );
    return template({ dictionary, file, options: options2, fileHeader: fileHeader_default });
  },
  "compose/object": function({ dictionary, options: options2, file }) {
    const template = _template__default["default"](
      fs2__default["default"].readFileSync(resolveTemplate("compose/object.kt.template"))
    );
    let allProperties;
    const { outputReferences } = options2;
  ...
  "ios/macros": function({ dictionary, options: options2, file }) {
    const template = _template__default["default"](
      fs2__default["default"].readFileSync(resolveTemplate("ios/macros.template"))
    );
  ...
  "ios/plist": function({ dictionary, options: options2, file }) {
    const template = _template__default["default"](
      fs2__default["default"].readFileSync(resolveTemplate("ios/plist.template"))
    );
    return template({ dictionary, options: options2, file, fileHeader: fileHeader_default });
  },
  "ios/singleton.m": function({ dictionary, options: options2, file }) {
    const template = _template__default["default"](
      fs2__default["default"].readFileSync(resolveTemplate("ios/singleton.m.template"))
    );
    return template({ dictionary, options: options2, file, fileHeader: fileHeader_default });
  },
  "ios/singleton.h": function({ dictionary, options: options2, file }) {
    const template = _template__default["default"](
      fs2__default["default"].readFileSync(resolveTemplate("ios/singleton.h.template"))
    );
    return template({ dictionary, options: options2, file, fileHeader: fileHeader_default });
  },
  "ios/static.h": function({ dictionary, options: options2, file }) {
    const template = _template__default["default"](
      fs2__default["default"].readFileSync(resolveTemplate("ios/static.h.template"))
    );
    return template({ dictionary, options: options2, file, fileHeader: fileHeader_default });
  },
  "ios/static.m": function({ dictionary, options: options2, file }) {
    const template = _template__default["default"](
      fs2__default["default"].readFileSync(resolveTemplate("ios/static.m.template"))
    );
    return template({ dictionary, options: options2, file, fileHeader: fileHeader_default });
  },
  "ios/colors.h": function({ dictionary, options: options2, file }) {
    const template = _template__default["default"](
      fs2__default["default"].readFileSync(resolveTemplate("ios/colors.h.template"))
    );
    return template({ dictionary, options: options2, file, fileHeader: fileHeader_default });
  },
  "ios/colors.m": function({ dictionary, options: options2, file }) {
    const template = _template__default["default"](
      fs2__default["default"].readFileSync(resolveTemplate("ios/colors.m.template"))
    );
    return template({ dictionary, options: options2, file, fileHeader: fileHeader_default });
  },
  "ios/strings.h": function({ dictionary, options: options2, file }) {
    const template = _template__default["default"](
      fs2__default["default"].readFileSync(resolveTemplate("ios/strings.h.template"))
    );
    return template({ dictionary, options: options2, file, fileHeader: fileHeader_default });
  },
  "ios/strings.m": function({ dictionary, options: options2, file }) {
    const template = _template__default["default"](
      fs2__default["default"].readFileSync(resolveTemplate("ios/strings.m.template"))
    );
    return template({ dictionary, options: options2, file, fileHeader: fileHeader_default });
  },
  "ios-swift/class.swift": function({ dictionary, options: options2, file, platform }) {
    const template = _template__default["default"](
      fs2__default["default"].readFileSync(resolveTemplate("ios-swift/any.swift.template"))
    );
    let allTokens;
    const { outputReferences } = options2;
  ...
  "css/fonts.css": _template__default["default"](
    fs2__default["default"].readFileSync(resolveTemplate("css/fonts.css.template"))
  ),
...
${dictionary.allTokens.map((token) => {
  ...
  "flutter/class.dart": function({ dictionary, options: options2, file }) {
    const template = _template__default["default"](
      fs2__default["default"].readFileSync(resolveTemplate("flutter/class.dart.template"))
    );
    let allTokens;
    const { outputReferences } = options2;
    const formatProperty = createPropertyFormatter_default({
...
var actions_default = {
  "android/copyImages": {
    do(dictionary, config) {
      ...
      dictionary.allTokens.forEach((token) => {
        if (token.attributes.category === "asset" && token.attributes.type === "image") {
          ...
          fs3__default["default"].copySync(token.value, `${imagesDir + token.attributes.state}/${name}.png`);
        }
      });
    },
    undo(dictionary, config) {
      ...
      dictionary.allTokens.forEach((token) => {
        if (token.attributes.category === "asset" && token.attributes.type === "image") {
          const name = token.path.slice(2, 4).join("_");
          fs3__default["default"].removeSync(`${imagesDir + token.attributes.state}/${name}.png`);
        }
      });
    }
  },
  "copy_assets": {
    do(dictionary, config) {
      ...
      fs3__default["default"].copySync("assets", `${config.buildPath}assets`);
    },
    undo(dictionary, config) {
      logger_default().log(`Removing assets directory from ${config.buildPath}assets`);
      fs3__default["default"].removeSync(`${config.buildPath}assets`);
    }
  }
};
...
function registerTemplate(options2) {
  if (typeof options2.name !== "string")
    throw new Error(`Template name must be a string: ${chalk2__default["default"].red(JSON.stringify(options2.name))}`);
  if (typeof options2.template !== "string")
    throw new Error(`Template path must be a string: ${chalk2__default["default"].red(JSON.stringify(options2.template))}`);
  if (!fs2__default["default"].existsSync(options2.template))
    throw new Error(`Can't find template: ${chalk2__default["default"].red(JSON.stringify(options2.template))}`);
  groupMessages_default.add(
    REGISTER_TEMPLATE_DEPRECATION_WARNINGS,
    `${options2.name}`
  );
  const template_string = fs2__default["default"].readFileSync(options2.template);
  this.format[options2.name] = _template__default["default"](template_string);
  return this;
}
...
function buildFile(file = {}, platform = {}, dictionary = {}) {
  ...
  if (typeof destination === "string") {
    ...
    const dirname3 = path4__default["default"].dirname(fullDestination);
    if (!fs3__default["default"].existsSync(dirname3))
      fs3__default["default"].mkdirsSync(dirname3, { recursive: true });
  }
  ...
  if (filteredProperties.hasOwnProperty("properties") && Object.keys(filteredProperties.properties).length === 0 && filteredProperties.properties.constructor === Object) {
    ...
    !silent && logger_default().log(chalk2__default["default"].red(warnNoFile));
    return null;
  }
  ...
  Object.keys(nameCollisionObj).forEach((propertyName) => {
    if (nameCollisionObj[propertyName].length > 1) {
      const collisions = nameCollisionObj[propertyName].map((properties) => {
        const propertyPathText = chalk2__default["default"].red(properties.path.join("."));
        const valueText = chalk2__default["default"].red(properties.value);
        return `${propertyPathText}   ${valueText}`;
      }).join("\n        ");
      groupMessages_default.add(
        PROPERTY_NAME_COLLISION_WARNINGS,
        `Output name ${chalk2__default["default"].red.bold(propertyName)} was generated by:
        ${collisions}`
      );
    }
  });
  ...
  if (!silent) {
    if ((nested || propertyNamesCollisionCount === 0) && filteredReferencesCount === 0) {
      logger_default().log(chalk2__default["default"].bold.green(`\u2714\uFE0E ${fullDestination}`));
    } else {
      ...
      if (propertyNamesCollisionCount > 0) {
        ...
        const title = `While building ${chalk2__default["default"].red.bold(destination || id)}, token collisions were found; output may be unexpected.`;
        const help = chalk2__default["default"].red([
...
${help}`;
        logger_default().log(chalk2__default["default"].red.bold(warn));
      }
      if (filteredReferencesCount > 0) {
        ...
        const title = `While building ${chalk2__default["default"].red.bold(destination || id)}, filtered out token references were found; output may be unexpected. Here are the references that are used but not defined in the file`;
        const help = chalk2__default["default"].red([
...
function cleanFile(file = {}, platform = {}) {
  ...
  if (!fs3__default["default"].existsSync(destination)) {
    !silent && logger_default().log(`${chalk2__default["default"].bold.red("!")} ${destination}, does not exist`);
    return;
  }
  fs3__default["default"].unlinkSync(destination);
  !silent && logger_default().log(`${chalk2__default["default"].bold.red("-")} ${destination}`);
}
...
function cleanDir(file = {}, platform = {}) {
  ...
  if (platform.buildPath)
    destination = platform.buildPath + destination;
  let dirname3 = path4__default["default"].dirname(destination);
  while (dirname3) {
    if (fs3__default["default"].existsSync(dirname3)) {
      if (fs3__default["default"].readdirSync(dirname3).length === 0) {
        !silent && logger_default().log(`${chalk2__default["default"].bold.red("-")} ${dirname3}`);
        fs3__default["default"].rmdirSync(dirname3);
      } else {
        break;
      }
    }
...
function resolveFileContent_default(resolvedPath) {
  ...
  if (resolvedPath.match(/.json5$/)) {
    const source = fs2__default["default"].readFileSync(resolvedPath, { encoding: "UTF-8" });
...
function combineJSON(arr, deep, collision, source, parsers = []) {
  ...
  for (i = 0; i < files.length; i++) {
    ...
    const resolvedPath = path4__default["default"].isAbsolute(files[i]) ? files[i] : path4__default["default"].resolve(process.cwd(), files[i]);
    let file_content = null;
    try {
      parsers.forEach(({ pattern, parse }) => {
        if (resolvedPath.match(pattern)) {
          file_content = parse({
            contents: fs2__default["default"].readFileSync(resolvedPath, { encoding: "UTF-8" }),
...
process.on("exit", () => {
  if (groupMessages_default.count(TEMPLATE_DEPRECATION_WARNINGS2) > 0) {
    ...
    logger_default().log(chalk2__default["default"].bold.yellow(`
...
custom templates:
  ...
  if (groupMessages_default.count(SASS_MAP_FORMAT_DEPRECATION_WARNINGS2) > 0) {
    ...
    logger_default().log(chalk2__default["default"].bold.cyan(`
